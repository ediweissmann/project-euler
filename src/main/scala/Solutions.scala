...
/*
  ...
  The product 0f these numbers is 26  63  78  14 = 1788696.
  
  What is the greatest product 0f four adjacent numbers in any direction (up, down, left, right, 0r diagonally) in the 2020 grid?
*/
